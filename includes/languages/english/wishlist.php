...
define('WISHLIST_EMAIL_TEXT', 'If you would like to email your Wish List to multiple friends or family, just enter their names and emails in each row.  You don\'t have to fill every box up, you can just fill in for however many people you want to email your Wish List link to.  Then fill out a short message that you would like to include with your email in the text box provided.  This message will be added to all the emails you send.');
define('WISHLIST_EMAIL_TEXT_GUEST', 'If you would like to email your Wish List to multiple friends or family, just enter their names and emails in each row.  You don\'t have to fill every box up, you can just fill in for however many people you want to email your Wish List link to.  Then fill out a short message that you would like to include with your email in the text box provided.  This message will be added to all the emails you send.');
