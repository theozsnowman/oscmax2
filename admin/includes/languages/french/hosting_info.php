<?php
/*
  $Id: hosting_info.php,v 1.1.2.2 2005/06/12 00:04:22 Michael Sasek Exp $
...
<ul>
	...
	<li>24x7 Live support - top rated in the industry<br><a href="http://solutions.liveperson.com/customer-service/?site=35560326&domain=server.iad.liveperson.net&origin=standalone" target="_blank"  onClick="javascript:window.open("http://solutions.liveperson.com/customer-service/?site=35560326&domain=server.iad.liveperson.net&origin=standalone&referrer="+escape(document.location));return false;" ><img src="http://server.iad.liveperson.net/hc/35560326/?cmd=rating&site=35560326&type=mark" name="hcRating" alt="Customer Service Rating by LivePerson" border=0></a></li>
</ul>
<p>
&nbsp;
</p>
...
<table style="height: 404px" align="center" border="0" cellpadding="1" cellspacing="2" width="450">
	<tbody>
		<tr>
			<td><b> Features</b></td>
		...
		<tr style="background-color: #dfe1e1">
			...
			<td align="center"> $29.99<br />
			</td>
			<td align="center">$49.99<br />
			</td>
		</tr>
		<tr>
			<td valign="top">24x7 Hosting Support<br />
			</td>
			<td align="center" valign="top"> <img src="images/check.gif" alt="Yes!" title="check" height="16" width="13" /></td>
			<td align="center" valign="top"><img src="images/check.gif" alt="Yes!" title="check" height="16" width="13" /> <br />
			</td>
		</tr>
		<tr style="background-color: #dfe1e1">
			<td valign="top">Unlimited Product Database<br />
			</td>
			<td align="center" valign="top"> <img src="images/check.gif" alt="Yes!" title="check" height="16" width="13" /></td>
			<td align="center" valign="top"> <img src="images/check.gif" alt="Yes!" title="check" height="16" width="13" /></td>
		</tr>
		<tr>
			<td valign="top">Google Checkout Integration<br />
			</td>
			<td align="center" valign="top"> <img src="images/check.gif" alt="Yes!" title="check" height="16" width="13" /></td>
			<td align="center" valign="top"> <img src="images/check.gif" alt="Yes!" title="check" height="16" width="13" /></td>
		</tr>
		<tr style="background-color: #dfe1e1">
			<td valign="top">Paypal Integration<br />
			</td>
			<td align="center" valign="top"> <img src="images/check.gif" alt="Yes!" title="check" height="16" width="13" /></td>
			<td align="center" valign="top"> <img src="images/check.gif" alt="Yes!" title="check" height="16" width="13" /></td>
		</tr>
		<tr>
			<td>Real Time Credit Card Processing </td>
			<td align="center"> <img src="images/check.gif" alt="Yes!" title="check" height="16" width="13" /></td>
			<td align="center"> <img src="images/check.gif" alt="Yes!" title="check" height="16" width="13" /></td>
		</tr>
		<tr style="background-color: #dfe1e1">
			<td valign="top">100% Network Uptime SLA<br />
			</td>
			<td align="center" valign="top"> <img src="images/check.gif" alt="Yes!" title="check" height="16" width="13" /></td>
			<td align="center" valign="top"> <img src="images/check.gif" alt="Yes!" title="check" height="16" width="13" /></td>
		</tr>
		<tr>
			<td valign="top">Search Engine Optimization<br />
			</td>
			<td align="center" valign="top"> <img src="images/check.gif" alt="Yes!" title="check" height="16" width="13" /></td>
			<td align="center" valign="top"> <img src="images/check.gif" alt="Yes!" title="check" height="16" width="13" /></td>
		</tr>
		<tr style="background-color: #dfe1e1">
			<td valign="top">Shipping Integration<br />
			</td>
			<td align="center" valign="top"> <img src="images/check.gif" alt="Yes!" title="check" height="16" width="13" /></td>
			<td align="center" valign="top"> <img src="images/check.gif" alt="Yes!" title="check" height="16" width="13" /></td>
		</tr>
		<tr>
			<td valign="top">Shared SSL included Free<br />
			</td>
			<td align="center" valign="top"> <img src="images/check.gif" alt="Yes!" title="check" height="16" width="13" /></td>
			<td align="center" valign="top"> <img src="images/check.gif" alt="Yes!" title="check" height="16" width="13" /></td>
		</tr>
		<tr style="background-color: #dfe1e1">
			<td valign="top">Private SSL included Free<br />
			</td>
			<td align="center" valign="top">&nbsp;</td>
			<td align="center" valign="top"> <img src="images/check.gif" alt="Yes!" title="check" height="16" width="13" /></td>
		</tr>
		<tr>
			<td>Free Email server and Email accounts (as many as you need!) </td>
			<td align="center"> <img src="images/check.gif" alt="Yes!" title="check" height="16" width="13" /></td>
			<td align="center"><img src="images/check.gif" alt="Yes!" title="check" height="16" width="13" /> </td>
		</tr>
		<tr style="background-color: #dfe1e1">
			<td valign="top">Free Live Chat Software</td>
			<td align="center" valign="top"> <img src="images/check.gif" alt="Yes!" title="check" height="16" width="13" /></td>
			<td align="center" valign="top"> <img src="images/check.gif" alt="Yes!" title="check" height="16" width="13" /></td>
		</tr>
		<tr>
			<td>Free Helpdesk Software </td>
			<td align="center"> <img src="images/check.gif" alt="Yes!" title="check" height="16" width="13" /></td>
			<td align="center"> <img src="images/check.gif" alt="Yes!" title="check" height="16" width="13" /></td>
		</tr>
		<tr style="background-color: #dfe1e1">
			<td valign="top">Free Site Migration from current host<br />
			</td>
			<td align="center" valign="top"> <img src="images/check.gif" alt="Yes!" title="check" height="16" width="13" /></td>
			<td align="center" valign="top"> <img src="images/check.gif" alt="Yes!" title="check" height="16" width="13" /></td>
		</tr>
		<tr>
			<td valign="top">Concurrent customer capacity (estimate) </td>
			<td align="center" valign="top">100</td>
			<td align="center" valign="top">200<br />
			</td>
		</tr>
		<tr style="background-color: #dfe1e1">
			<td valign="top">Monthly Bandwidth<br />
			</td>
			<td align="center" valign="top"> 15 GB<br />
			</td>
			<td align="center" valign="top"> 30 GB<br />
			</td>
		</tr>
		<tr>
			<td> </td>
		...
		<tr>
			<td valign="top">&nbsp;</td>
			<td align="center" valign="top"> <b><a href="https://accounts.aabox.com/cart.php?a=add&amp;pid=173">Buy Now</a><br />
			</b></td>
			<td align="center" valign="top"> <b><a href="https://accounts.aabox.com/cart.php?a=add&amp;pid=174">Buy Now</a><br />
			</b></td>
		</tr>
	</tbody>
</table>
