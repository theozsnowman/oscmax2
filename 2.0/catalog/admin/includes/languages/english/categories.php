...
define('TEXT_PRODUCTS_IMAGE', '<small>(optional) </small>Large Image:');
...
define('TEXT_UPLOAD_DYNAMIC_MOPICS', 'Additional Images (optional):');
define('TEXT_PRODUCTS_THUMB', 'Main Image <small>(thumbnail)</small>:');
?>
