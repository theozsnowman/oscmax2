...
// BOF: MOD - Country-State Selector
        ...
        if (count($zones_array) > 0) {
          echo tep_draw_pull_down_menu('state', $zones_array) . '<span class="inputRequirement"><br>' . ENTRY_STATE_TEXT . '</span>';
        } else {
...
?></td>
          ...
          <tr>
            ...
            <td class="main">&nbsp;
<?php
  echo tep_get_country_list('country',$country,'onChange="return refresh_form(account_edit);"') . '&nbsp;' . (tep_not_null(ENTRY_COUNTRY_TEXT) ? '<span class="inputRequirement"><br>' . ENTRY_COUNTRY_TEXT . '</span>': '');
?>
</td>
          </tr>
