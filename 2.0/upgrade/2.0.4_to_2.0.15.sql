...
ALTER TABLE affiliate_affiliate 
	CHANGE affiliate_gender affiliate_gender char(1)  NOT NULL DEFAULT '' after affiliate_id, 
	CHANGE affiliate_firstname affiliate_firstname varchar(32)  NOT NULL DEFAULT '' after affiliate_gender, 
	CHANGE affiliate_lastname affiliate_lastname varchar(32)  NOT NULL DEFAULT '' after affiliate_firstname, 
	CHANGE affiliate_dob affiliate_dob datetime   NOT NULL DEFAULT '0000-00-00 00:00:00' after affiliate_lastname, 
	CHANGE affiliate_email_address affiliate_email_address varchar(96)  NOT NULL DEFAULT '' after affiliate_dob, 
	CHANGE affiliate_telephone affiliate_telephone varchar(32)  NOT NULL DEFAULT '' after affiliate_email_address, 
	CHANGE affiliate_fax affiliate_fax varchar(32)  NOT NULL DEFAULT '' after affiliate_telephone, 
	CHANGE affiliate_password affiliate_password varchar(40)  NOT NULL DEFAULT '' after affiliate_fax, 
	CHANGE affiliate_homepage affiliate_homepage varchar(96)  NOT NULL DEFAULT '' after affiliate_password, 
	CHANGE affiliate_street_address affiliate_street_address varchar(64)  NOT NULL DEFAULT '' after affiliate_homepage, 
	CHANGE affiliate_suburb affiliate_suburb varchar(64)  NOT NULL DEFAULT '' after affiliate_street_address, 
	CHANGE affiliate_city affiliate_city varchar(32)  NOT NULL DEFAULT '' after affiliate_suburb, 
	CHANGE affiliate_postcode affiliate_postcode varchar(10)  NOT NULL DEFAULT '' after affiliate_city, 
	CHANGE affiliate_state affiliate_state varchar(32)  NOT NULL DEFAULT '' after affiliate_postcode, 
	CHANGE affiliate_company affiliate_company varchar(60)  NOT NULL DEFAULT '' after affiliate_agb, 
	CHANGE affiliate_company_taxid affiliate_company_taxid varchar(64)  NOT NULL DEFAULT '' after affiliate_company, 
	CHANGE affiliate_payment_check affiliate_payment_check varchar(100)  NOT NULL DEFAULT '' after affiliate_commission_percent, 
	CHANGE affiliate_payment_paypal affiliate_payment_paypal varchar(64)  NOT NULL DEFAULT '' after affiliate_payment_check, 
	CHANGE affiliate_payment_bank_name affiliate_payment_bank_name varchar(64)  NOT NULL DEFAULT '' after affiliate_payment_paypal, 
	CHANGE affiliate_payment_bank_branch_number affiliate_payment_bank_branch_number varchar(64)  NOT NULL DEFAULT '' after affiliate_payment_bank_name, 
	CHANGE affiliate_payment_bank_swift_code affiliate_payment_bank_swift_code varchar(64)  NOT NULL DEFAULT '' after affiliate_payment_bank_branch_number, 
	CHANGE affiliate_payment_bank_account_name affiliate_payment_bank_account_name varchar(64)  NOT NULL DEFAULT '' after affiliate_payment_bank_swift_code, 
	CHANGE affiliate_payment_bank_account_number affiliate_payment_bank_account_number varchar(64)  NOT NULL DEFAULT '' after affiliate_payment_bank_account_name;


ALTER TABLE affiliate_banners 
	CHANGE affiliate_banners_title affiliate_banners_title varchar(64)  NOT NULL DEFAULT '' after affiliate_banners_id, 
	CHANGE affiliate_banners_image affiliate_banners_image varchar(64)  NOT NULL DEFAULT '' after affiliate_category_id, 
	CHANGE affiliate_banners_group affiliate_banners_group varchar(10)  NOT NULL DEFAULT '' after affiliate_banners_image;


ALTER TABLE affiliate_news 
	ADD COLUMN headline varchar(255)  NOT NULL DEFAULT '' after news_id, 
	ADD COLUMN content text  NOT NULL after headline, 
	CHANGE date_added date_added datetime   NOT NULL DEFAULT '0000-00-00 00:00:00' after content, 
	CHANGE news_status news_status tinyint(1)   NOT NULL DEFAULT '0' after date_added;


ALTER TABLE affiliate_news_contents 
	CHANGE affiliate_news_headlines affiliate_news_headlines varchar(255)  NOT NULL DEFAULT '' after affiliate_news_languages_id;


ALTER TABLE affiliate_payment 
	CHANGE affiliate_firstname affiliate_firstname varchar(32)  NOT NULL DEFAULT '' after affiliate_payment_status, 
	CHANGE affiliate_lastname affiliate_lastname varchar(32)  NOT NULL DEFAULT '' after affiliate_firstname, 
	CHANGE affiliate_street_address affiliate_street_address varchar(64)  NOT NULL DEFAULT '' after affiliate_lastname, 
	CHANGE affiliate_suburb affiliate_suburb varchar(64)  NOT NULL DEFAULT '' after affiliate_street_address, 
	CHANGE affiliate_city affiliate_city varchar(32)  NOT NULL DEFAULT '' after affiliate_suburb, 
	CHANGE affiliate_postcode affiliate_postcode varchar(10)  NOT NULL DEFAULT '' after affiliate_city, 
	CHANGE affiliate_company affiliate_company varchar(60)  NOT NULL DEFAULT '' after affiliate_country;


ALTER TABLE affiliate_payment_status 
	CHANGE affiliate_payment_status_name affiliate_payment_status_name varchar(32)  NOT NULL DEFAULT '' after affiliate_language_id;


ALTER TABLE affiliate_sales 
	CHANGE affiliate_browser affiliate_browser varchar(100)  NOT NULL DEFAULT '' after affiliate_date, 
	CHANGE affiliate_ipaddress affiliate_ipaddress varchar(20)  NOT NULL DEFAULT '' after affiliate_browser, 
	CHANGE affiliate_payment_date affiliate_payment_date datetime   NOT NULL DEFAULT '0000-00-00 00:00:00' after affiliate_billing_status;


ALTER TABLE countries 
	ADD COLUMN active tinyint(3) unsigned   NULL DEFAULT '1' after address_format_id;


ALTER TABLE customers 
	ADD COLUMN guest_account tinyint(1)   NOT NULL DEFAULT '0' after customers_newsletter, 
	CHANGE customers_login customers_login varchar(96)  NULL after guest_account, 
	CHANGE customers_group_name customers_group_name varchar(27)  NOT NULL DEFAULT 'Retail' after customers_login, 
	CHANGE customers_group_id customers_group_id int(11)   NOT NULL DEFAULT '0' after customers_group_name, 
	CHANGE customers_group_ra customers_group_ra enum('0','1')  NOT NULL DEFAULT '0' after customers_group_id, 
	CHANGE customers_payment_allowed customers_payment_allowed varchar(255)  NOT NULL after customers_group_ra, 
	CHANGE customers_shipment_allowed customers_shipment_allowed varchar(255)  NOT NULL after customers_payment_allowed;


ALTER TABLE customers_wishlist 
	CHANGE products_id products_id tinytext  NOT NULL first, 
	...
	DROP COLUMN wishlist_name;


ALTER TABLE whos_online 
	ADD COLUMN hostname varchar(255)  NOT NULL after ip_address, 
	ADD COLUMN country_code varchar(2)  NOT NULL after hostname, 
	ADD COLUMN country_name varchar(64)  NOT NULL after country_code, 
	ADD COLUMN region_name varchar(64)  NOT NULL after country_name, 
	ADD COLUMN city varchar(64)  NOT NULL after region_name, 
	ADD COLUMN latitude float   NOT NULL after city, 
	ADD COLUMN longitude float   NOT NULL after latitude, 
	CHANGE time_entry time_entry varchar(14)  NOT NULL after longitude, 
	CHANGE time_last_click time_last_click varchar(14)  NOT NULL after time_entry, 
	CHANGE last_page_url last_page_url text  NOT NULL after time_last_click, 
	ADD COLUMN http_referer varchar(255)  NOT NULL after last_page_url, 
	ADD COLUMN user_agent varchar(255)  NOT NULL after http_referer, 
...
INSERT INTO `configuration` VALUES ('1220', 'Tax Rates used for billing the affiliates', 'AFFILIATE_TAX_ID', '1', 'Set the tax rate for billing affiliates', '35', '17', NULL, '', NULL, NULL);
...
INSERT INTO `configuration` VALUES ('598', 'Product Popup Image Height', 'POPUP_IMAGE_HEIGHT', '600', 'Limits the popup product image (enlarged) size during product updates. MUST specify.', '4', '23', NULL, '', NULL, NULL);
INSERT INTO `configuration` VALUES ('597', 'Product Popup Image Width', 'POPUP_IMAGE_WIDTH', '800', 'Limits the popup product image (enlarged) size during product updates. MUST specify.', '4', '22', NULL, '', NULL, NULL);
INSERT INTO `configuration` VALUES ('596', 'Product Image Height', 'PRODUCT_IMAGE_HEIGHT', '', 'The main product image (thumbnail) in product information pages. Do NOT specify both!', '4', '21', NULL, '', NULL, NULL);
INSERT INTO `configuration` VALUES ('1219', 'Delete affiliate sale if order deleted?', 'AFFILIATE_NOTIFY_AFTER_BILLING', 'true', 'Delete affiliate sales if an order is deleted (Warning: Only not yet billed sales are deleted)', '35', '16', NULL, '', NULL, 'tep_cfg_select_option(array(\'true\', \'false\'),');
INSERT INTO `configuration` VALUES ('1218', 'Notify Affiliate of new invoice?', 'AFFILIATE_NOTIFY_AFTER_BILLING', 'true', 'Nofify affiliate if they have got a new invoice', '35', '15', NULL, '', NULL, 'tep_cfg_select_option(array(\'true\', \'false\'),');
INSERT INTO `configuration` VALUES ('595', 'Product Image Width', 'PRODUCT_IMAGE_WIDTH', '120', 'The main product image (thumbnail) in product information pages.', '4', '20', NULL, '', NULL, NULL);
...
INSERT INTO `configuration` VALUES ('1221', 'Maintain affiliate clickthroughs', 'AFFILIATE_DELETE_CLICKTHROUGHS', 'false', 'To keep the clickthrough report small you can set the days after which they are deleted (when calling affiliate_summary in the admin).  Set to false or set the number of days.', '35', '18', NULL, '', NULL, NULL);
INSERT INTO `configuration` VALUES ('77', 'Google Maps Key', 'GOOGLE_MAPS_KEY', 'YOURKEY', 'Put your Google Maps API Key here.<br><br>You can get one at http://code.google.com/apis/maps/signup.html', '1', '25', NULL, '', NULL, 'tep_cfg_textarea(');
INSERT INTO `currencies` VALUES ('3', 'UK Pound', 'GBP', '£', '', '.', ',', '2', '1.00000000', '');
