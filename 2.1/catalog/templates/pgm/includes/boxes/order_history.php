...
<?php
      ...
      while ($products = tep_db_fetch_array($products_query)) {
        $boxContent .= '  <tr>' .
                                   ...
                                   '    <td class="infoBoxContents" align="right" valign="top"><a href="' . tep_href_link(basename($PHP_SELF), tep_get_all_get_params(array('action')) . 'action=cust_order&pid=' . $products['products_id']) . '">' . tep_image(DIR_WS_TEMPLATES . 'images/cart_put.png', ICON_CART) . '</a></td>' .
                                   '  </tr>';
      }
      $boxContent .= '</table>';
