    ...
    <?php echo tep_draw_form('cart_quantity', tep_href_link(FILENAME_SHOPPING_CART, 'action=update_product')); ?><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
          <tr>
            <td class="pageHeading" height="27"><?php echo HEADING_TITLE; ?></td>
...
//++++ QT Pro: End Changed Code
    ...
    for ($i=0, $n=sizeof($products); $i<$n; $i++) {
      if (($i/2) == floor($i/2)) {
        $info_box_contents[] = array('params' => 'class="cart-even"');
      } else {
        $info_box_contents[] = array('params' => 'class="cart-odd"');
      }
	...
	'text' => '<a href="' . tep_href_link(FILENAME_SHOPPING_CART, 'action=remove_product&products_id='.$products[$i]['id'].'', 'NONSSL').'">' . tep_image(DIR_WS_TEMPLATES . 'images/basket_delete.png', IMAGE_BUTTON_REMOVE_PRODUCT, 16, 16) . '</a>');
      ...
      <tr class="infoBoxContents">
        <td align="center" class="main">
			<table border="0" width="100%" cellspacing="0" cellpadding="2">
				<tr valign="middle">
        			<td>
						<?php echo tep_image(DIR_WS_TEMPLATES . 'images/bag.png', ''); ?>
        			</td>
        			<td valign="top" align="left" class="baskettext">
					There are currently <b>no items</b> in your basket.
                    <p>
                    Please use the menus at the top and left of this page to browse our products.  When you find something you like use the 'Add to Basket' button to purchase.
                    <p>
                    If you need any further assistance please do not hesitate to <b><?php echo '<a href="' . tep_href_link(FILENAME_CONTACT_US) . '">' ?>contact us</a></b> and we will do everything we can to help you.
			        </td>
        		</tr>
        	</table>
        </td>
