...
if (sizeof($featured_manufacturer_products_array) <> '0') { 
  ...
  for($i=0,$col=1; $i<sizeof($featured_manufacturer_products_array); $i++,$col++) {
    ...
    if (SHOW_MORE_INFO == 'True') {
      $more_info = '<br><a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $featured_manufacturer_products_array[$i]['pid']) . '">' . tep_image_button('button_more_info.gif', IMAGE_BUTTON_MORE_INFO) . '</a> ';
	} else {
      $more_info = '<br>';
	}
    ...
    if (FEATURED_SET_SHOW_BUY_NOW_BUTTONS=='true') {
	  ...
	  if ($featured_manufacturer_products_array[$i]['pprice'] == CALL_FOR_PRICE_VALUE) {
        $buy_now_link = '<a href="' . tep_href_link(FILENAME_CONTACT_US, 'enquiry=' . TEXT_QUESTION_PRICE_ENQUIRY . '%0D%0A%0D%0A' . TEXT_QUESTION_MODEL . '%20' . str_replace(' ', '%20', $featured_manufacturer_products_array[$i]['pmodel']) . '%0D%0A' . TEXT_QUESTION_PRODUCT_NAME . '%20' . str_replace(' ', '%20', $featured_manufacturer_products_array[$i]['pname']) . '%0D%0A' . TEXT_QUESTION_PRODUCT_ID . '%20' . $featured_manufacturer_products_array[$i]['pid'] . '%0D%0A%0D%0A') . '">' . tep_image_button('button_cfp.gif', IMAGE_BUTTON_CFP) . '</a>';
	  } else {
		$buy_now_link = '<a href="' . tep_href_link(FILENAME_DEFAULT, tep_get_all_get_params(array('action')) . 'action=buy_now&products_id=' . $featured_manufacturer_products_array[$i]['pid'], 'NONSSL') . '">' . tep_image_button('button_buy_now.gif', IMAGE_BUTTON_BUY_NOW) . '</a>';
	  }
  ...
  if ((FEATURED_MANUFACTURER_SET == '2') && (FEATURED_MANUFACTURER_SET_STYLE == '1')) { 
    ...
    $info_box_contents[0]['text'] .= $current_description;
    $info_box_contents[0]['text'] .= '&nbsp;&nbsp;<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $featured_manufacturer_products_array[$i]['pid'], 'NONSSL') . '"><font color="#FF0000">' . TEXT_MORE_INFO . '</font></a>&nbsp;</td></tr><tr><td align="left" valign="top" class="featuredManufacturerWP">' . OPEN_FEATURED_TABLE_HEADING_PRICE . $products_price . '<br>' . $more_info . $buy_now_link . '</td></tr></table>'."\n";
  }
  ...
  if ((FEATURED_MANUFACTURER_SET == '2') && (FEATURED_MANUFACTURER_SET_STYLE == '3')) {
    ...
    $info_box_contents[0]['text'] .= $current_description;
    $info_box_contents[0]['text'] .= '&nbsp;&nbsp;<a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $featured_manufacturer_products_array[$i]['pid'], 'NONSSL') . '"><font color="#FF0000">' . TEXT_MORE_INFO . '</font></a>&nbsp;<br>' . OPEN_FEATURED_TABLE_HEADING_PRICE . $products_price . '<br>' . $more_info . $buy_now_link . '</td>'.(((FEATURED_MANUFACTURER_COLUMNS>1)&&(($col/$num_columns)!=floor($col/$num_columns)))?'<td align="center" class="featuredManufacturerWP" width="'.MANUFACTURER_LINE_THICKNESS.'" style="height: '.MANUFACTURER_VLINE_IMAGE_HEIGHT.'px;"><div style="background-color: #'.MANUFACTURER_LINE_COLOR.'; height: '.MANUFACTURER_VLINE_IMAGE_HEIGHT.'px; width: '.MANUFACTURER_LINE_THICKNESS.'px;">' . tep_draw_separator('pixel_trans.gif', MANUFACTURER_LINE_THICKNESS, MANUFACTURER_VLINE_IMAGE_HEIGHT) . '</div></td>':'').'</tr></table>'."\n";
  }
  ...
  if ((FEATURED_MANUFACTURER_SET == '4') && (FEATURED_MANUFACTURER_SET_STYLE == '1')) {
	...
	$info_box_contents[0]['text'] .= $featured_manufacturer_products_array[$i]['pname'] . '</a><br>' . OPEN_FEATURED_TABLE_HEADING_PRICE . str_replace('&nbsp;&nbsp;','<br>',$products_price) . '<br>' . $more_info . $buy_now_link . '</td></tr></table>'."\n";
  }
  ...
  if ((FEATURED_MANUFACTURER_SET == '4') && ((FEATURED_MANUFACTURER_SET_STYLE == '4') || (FEATURED_MANUFACTURER_SET_STYLE == '6'))) {
    $info_box_contents[0]['text'] .= '<table border="0" width="100%" cellspacing="0" cellpadding="'.MANUFACTURER_CELLPADDING.'"><tr><td align="center" valign="top" class="featuredManufacturerWP"><a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $featured_manufacturer_products_array[$i]['pid'], 'NONSSL') . '">' . tep_image(DIR_WS_IMAGES . DYNAMIC_MOPICS_THUMBS_DIR . $featured_manufacturer_products_array[$i]['pimage'], $featured_manufacturer_products_array[$i]['pname'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT) . '</a>' . 
      '<br><a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $featured_manufacturer_products_array[$i]['pid'], 'NONSSL') . '">' . $featured_manufacturer_products_array[$i]['pname'] . '</a><br>' . OPEN_FEATURED_TABLE_HEADING_PRICE . str_replace('&nbsp;&nbsp;','<br>',$products_price) . $more_info . $buy_now_link . '</td></tr></table>'."\n";
  }
