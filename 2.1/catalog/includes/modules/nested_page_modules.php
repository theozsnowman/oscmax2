...
<?php
$page_modules_query_raw = "select pm_filename, pm_active, pm_page, pm_sort_order from " . TABLE_PM_CONFIGURATION . " where pm_page = 'nested' and pm_filename <>'' and pm_active = 'yes' order by pm_sort_order";
