...
if (sizeof($featured_categories_array) <> '0') { 
  ...
  if ((FEATURED_CATEGORIES_SET == '3') && (FEATURED_CATEGORIES_SET_STYLE == '1')) {
    $info_box_contents[0]['text'] .= '<table border="0" width="100%" cellspacing="0" cellpadding="'.CATEGORIES_CELLPADDING.'"><tr><td width="' . (SMALL_IMAGE_WIDTH + 25);
    $info_box_contents[0]['text'] .= '" align="center" valign="top" class="featuredCategories"><a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $featured_categories_array[$i]['pid'], 'NONSSL') . '">' . tep_image(DIR_WS_IMAGES . DYNAMIC_MOPICS_THUMBS_DIR . $featured_categories_array[$i]['pimage'], $featured_categories_array[$i]['pname'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT) . '</a><br>' . tep_image(DIR_WS_IMAGES . 'pixel_trans.gif', '', '1', '5') . '<br>' . OPEN_FEATURED_TABLE_HEADING_PRICE . $products_price . '' . $buy_now_link . '</td><td align="left" valign="top" class="featuredCategories"><div align="left"><a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $featured_categories_array[$i]['pid'], 'NONSSL') . '">' . $featured_categories_array[$i]['pname'] . '</a></div>';
    $info_box_contents[0]['text'] .= $current_description; 
  ...
  if ((FEATURED_CATEGORIES_SET == '3') && (FEATURED_CATEGORIES_SET_STYLE == '3')) {
    $info_box_contents[0]['text'] .= '<table border="0" width="100%" cellspacing="0" cellpadding="'.CATEGORIES_CELLPADDING.'"><tr><td width="' . (SMALL_IMAGE_WIDTH + 25);
    $info_box_contents[0]['text'] .= '" align="center" valign="top" class="featuredCategories" style="height: '.CATEGORIES_VLINE_IMAGE_HEIGHT.'px;"><a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $featured_categories_array[$i]['pid'], 'NONSSL') . '">' . tep_image(DIR_WS_IMAGES . DYNAMIC_MOPICS_THUMBS_DIR . $featured_categories_array[$i]['pimage'], $featured_categories_array[$i]['pname'], SMALL_IMAGE_WIDTH, SMALL_IMAGE_HEIGHT) . '</a><br>' . tep_image(DIR_WS_IMAGES . 'pixel_trans.gif', '', '1', '5') . '<br>' . OPEN_FEATURED_TABLE_HEADING_PRICE . $products_price . '' . $buy_now_link . '</td><td align="left" valign="top" class="featuredCategories"><div align="left"><a href="' . tep_href_link(FILENAME_PRODUCT_INFO, 'products_id=' . $featured_categories_array[$i]['pid'], 'NONSSL') . '">' . $featured_categories_array[$i]['pname'] . '</a></div>';
    $info_box_contents[0]['text'] .= $current_description; 
