...
*/
define('NAVBAR_TITLE','Pedido realizado');
define('HEADING_TITLE','Gracias por utilizar Google Checkout para realizar su pedido');
define('TEXT_ITEMS_PURCHASED','Productos comprados:');
