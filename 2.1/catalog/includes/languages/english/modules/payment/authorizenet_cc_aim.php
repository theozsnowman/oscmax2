...
*/
  ...
  define('MODULE_PAYMENT_AUTHORIZENET_CC_AIM_TEXT_DESCRIPTION', '<img src="images/icon_popup.gif" border="0">&nbsp;<a href="https://www.cdgcommerce.com/internet-services.php?R=1017" target="_blank" style="text-decoration: underline; font-weight: bold;">Get an Authorize.net account</a>');
