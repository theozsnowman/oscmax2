...
define('TEXT_NEEDS_TO_LOGIN','Nous sommes désolés mais nous ne pouvons pas traiter votre demande Chèques Cadeaux pour le moment. Vous devez vous connecter d\'abord ou créer un compte avec nous, si vous n\'avez déjà un, avant que vous pouvez demander votre chèque cadeau. S\'il vous plaît <a href="' . tep_href_link(FILENAME_LOGIN,'','SSL') .'">cliquez ici pour vous connecter ou créer un compte.</a>');
?>