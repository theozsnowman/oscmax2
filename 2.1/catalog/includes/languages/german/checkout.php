...
define('NAVBAR_TITLE', 'Einkauf abschlieÃŸen');
define('NAVBAR_TITLE_1', 'Einkauf abschlieÃŸen');

define('HEADING_TITLE', 'Einkauf abschlieÃŸen');
...
define('TABLE_HEADING_COMMENTS', 'Sie kÃ¶nnen Ihrer Bestellung eine Anmerkung hinzufügen');

define('TITLE_CONTINUE_CHECKOUT_PROCEDURE', 'Setzen Sie den Vorgang fort');
define('TEXT_CONTINUE_CHECKOUT_PROCEDURE', 'um Ihre Bestellung abzuschlieÃŸen.');
...
define('EMAIL_WELCOME', 'Wilkommen im Onlineshop von <b>' . STORE_NAME . '</b>.' . "\n\n");
define('EMAIL_TEXT', 'Sie kÃ¶nnen nun die <b>erweiterten Funktionen</b> nutzen, die unser Shop für Sie bereit hält, wie etwa:' . "\n\n" . '<li><b>PersÃ¶nlicher Warenkorb</b> - Der aktuelle Inhalt Ihres Warenkorbes wird beim Abmelden gespeichert und steht Ihnen bei der nächsten Anmeldung wieder zur Verfügung.' . "\n" . '<li><b>Adressbuch</b> - Speichern Sie unterschiedliche Lieferanschriften für künftige Bestellungen in Ihrem persÃ¶nlichen Adressbuch ab.' . "\n" . '<li><b>Frühere Bestellungen</b> - Sie erhalten eine Ãœbersicht aller von Ihnen getätigten Bestellungen.' . "\n" . '<li><b>Produktbewertungen</b> - Verfassen Sie einen Erfahrungsbericht zu unseren Produkten und verÃ¶ffentlichen Sie ihn online.' . "\n\n");
...
define('EMAIL_GV_REDEEM', 'Der Gutscheincode lautet %s und kann entweder bei Ihrem nächsten Einkauf eingelÃ¶st werden,');
define('EMAIL_GV_LINK', 'oder wenn Sie diesem Link folgen ');
define('EMAIL_COUPON_INCENTIVE_HEADER', 'Herzlichen Glückwunsch! Um Ihren ersten Einkauf in unserem Onlineshop noch lohnender für Sie zu machen, übersenden wir Ihnen einen Gutschein.' . "\n" . ' Nachstehend finden Sie die Details Ihres persÃ¶nlichen Gutscheins' . "\n");

define('EMAIL_COUPON_REDEEM', 'Um den Gutschein einzulÃ¶sen, geben Sie den angegebenen Code %s beim AbschlieÃŸen Ihrer Bestellung in das entsprechende Feld ein');
...
define('WINDOW_BUTTON_CONTINUE', 'Ãœbernehmen');
...
define('TEXT_HAVE_COUPON_CCGV', 'MÃ¶chten Sie einen Gutschein einlÃ¶sen?');
define('TEXT_HAVE_COUPON_KGT', 'MÃ¶chten Sie einen Gutschein einlÃ¶sen?');
...
define('CHECKOUT_BAR_CONFIRMATION', 'Bestellung abschlieÃŸen');
// Points/Rewards Module V2.1rc2a BOF
define('TABLE_HEADING_REDEEM_SYSTEM', 'Treuepunkte einlÃ¶sen ');
define('TABLE_HEADING_REFERRAL', 'Treuepunkte übertragen');
define('TEXT_REDEEM_SYSTEM_START', 'Sie haben ein Guthaben von %s . MÃ¶chten Sie es für diese Bestellung verwenden?<br />Die voraussichtliche Gesamtsumme Ihrer Bestellung beträgt: %s .');
define('TEXT_REDEEM_SYSTEM_SPENDING', 'Setzen Sie hier einen Haken, wenn Sie die hÃ¶chstmÃ¶gliche Punktezahl einlÃ¶sen mÃ¶chten, die bei diesem Einkauf mÃ¶glich ist. (%s Punktes %s)&nbsp;&nbsp;->');
define('TEXT_REDEEM_SYSTEM_NOTE', '<span class="pointWarning">Die Gesamtsumme ist hÃ¶her, als die hÃ¶chstzulässige Treuepunktanzahl, daher müssen Sie auch eine Zahlungsart auswählen</span>');
