...
define('TEXT_AFFILIATE_BANNERS_BUILD','Bauen Sie ein Link');
define('TEXT_AFFILIATE_BANNERS_PRODUCT','Produkt-Links');
...
define('IMAGE_PRODUCT','Produkt-Links');
define('IMAGE_BUILD','Bauen Sie ein Link');
