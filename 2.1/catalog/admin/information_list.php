...
<?php
		if ($val['visible'] == 1) {
			...
			echo tep_image(DIR_WS_ICONS . 'icon_status_red_light.gif', DEACTIVATION_ID_INFORMATION . " $val[information_id]", 10, 10);
			...
			echo tep_image(DIR_WS_ICONS . 'icon_status_green_light.gif', ACTIVATION_ID_INFORMATION . " $val[information_id]", 10, 10);
			echo ( (!strstr($info_group['locked'], 'visible')) ? '</a>' : null);
