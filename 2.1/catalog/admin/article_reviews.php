...
?>
                <td class="dataTableContent"><?php echo '<span title="' . $rInfo->customers_name . '|' . $rInfo->reviews_text . '">' . tep_image(DIR_WS_ICONS . 'page_white_text.png', ICON_PREVIEW) . '&nbsp;' . tep_get_articles_name($reviews['articles_id']); ?></span></td>
