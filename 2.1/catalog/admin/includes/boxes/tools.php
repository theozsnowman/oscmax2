...
<?php
  ...
  $contents = (					   tep_admin_jqmenu(FILENAME_RECOVER_CART_SALES, BOX_TOOLS_RECOVER_CART) .
                                   tep_admin_jqmenu(FILENAME_BACKUP, BOX_TOOLS_BACKUP) .
                                   ...
                                   tep_admin_jqmenu(FILENAME_IMAGE_MANAGER, BOX_TOOLS_IMAGE_MANAGER) .
								   ...
								   tep_admin_jqmenu(FILENAME_FAQ, BOX_TOOLS_FAQ) . 
