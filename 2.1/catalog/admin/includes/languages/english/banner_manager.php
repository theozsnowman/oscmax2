...
define('TEXT_BANNERS_GROUP_NOTE', '<b>Banner Groups:</b><ul><li>all - displays in the footer</li><li>index - displays on the index page in the main content area</li><li>product - displays on the product_info page</li><li>You can change the sort order of display in the module manager</li></ul>');
