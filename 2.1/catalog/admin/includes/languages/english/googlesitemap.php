...
define('INSTRUCTIONS_STEP1_GOOGLE_SITEMAPS', '<b>STEP 1:</b> Please regenerate your Google Sitemaps: ');
...
define('INSTRUCTIONS_STEP2_GOOGLE_SITEMAPS', '<b>STEP 2:</b> PING the google server to notify them of the update to your XML sitemap: ');
