...
define('TEXT_BANNERS_GROUP_NOTE', '<b>Banner-Gruppen:</b><ul><li>Alle - Anzeige im Footer</li><li>Index - Anzeige auf der Indexseite im Hauptinhaltsbereich</li><li>Produkt - Anzeige auf der product_info Seite</li><li>Sie können die Sortierreihenfolge im Modulmanager ändern</li></ul>');
define('TEXT_BANNERS_INSERT_NOTE', '<b>Bemerkung:</b><ul><li>Das Bildverzeichnis muss beschreibbar sein!</li><li>F&uuml;llen Sie das Feld \'Bildziel (Speichern nach)\' nicht aus, wenn Sie kein Bild auf Ihren Server kopieren m&ouml;chten (z.B. wenn sich das Bild bereits auf dem Server befindet).</li><li>Das \'Bildziel (Speichern nach)\' Feld muss ein bereits existierendes Verzeichnis mit \'/\' am Ende sein (z.B. banners/).</li></ul>'); 
