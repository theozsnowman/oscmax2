...
define('TABLE_HEADING_CROSS_PRODUCTS', 'Cross-Associated Produkt');
define('TABLE_HEADING_CROSS_SELL_ACTIONS', 'Cross-Sell Aktionen');
define('TABLE_HEADING_NAME', 'Name');
define('TABLE_HEADING_PRICE', 'Preis');
define('TABLE_HEADING_ITEM_NO', 'Sachnummer');
define('TABLE_HEADING_ITEM_NAME', 'Die Bezeichnung des Artikels');
define('TEXT_NEW_CROSS_SELL', 'Hier klicken um ein neues Cross-sell');
define('TEXT_CROSS_SELL_ADD', 'Hinzufügen');
define('TEXT_CROSS_SELL_REMOVE', 'Entfernen');
define('TEXT_CROSS_SELL_SORT', 'Art');
define('TEXT_CROSS_SELL_ORDER', 'Ordern - 1=Top');
define('TEXT_SEARCH_XSELL', 'Suche :');
