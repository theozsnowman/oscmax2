...
define('WARNING_PHP_FILES_IN_BIGIMAGES', 'Warnung: Es befinden sich PHP Dateien im ' . DIR_FS_CATALOG . DYNAMIC_MOPICS_BIGIMAGES_DIR . ' Bilderverzeichnis. Dies könnte auf eine Infizierung Ihres Servers durch bösartige Software hindeuten.');
define('WARNING_PHP_FILES_IN_PRODUCTS', 'Warnung: Es befinden sich PHP Dateien im ' . DIR_FS_CATALOG . DYNAMIC_MOPICS_PRODUCTS_DIR . ' Bilderverzeichnis. Dies könnte auf eine Infizierung Ihres Servers durch bösartige Software hindeuten.');
define('WARNING_PHP_FILES_IN_THUMBS', 'Warnung: Es befinden sich PHP Dateien im ' . DIR_FS_CATALOG . DYNAMIC_MOPICS_THUMBS_DIR . ' Bilderverzeichnis. Dies könnte auf eine Infizierung Ihres Servers durch bösartige Software hindeuten.');
?>