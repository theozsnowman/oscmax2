...
UPDATE `information` SET `information_id`='15', `information_group_id`='1', `information_title`='Información afiliado', `information_description`='<p>\r\n	Su información de afiliado va aquí</p>', `information_url`='', `information_target`='_top', `parent_id`='0', `sort_order`='8', `visible`='1', `language_id`='3'  WHERE (`information_id` = 15 AND `language_id` = 3) ;
UPDATE `information` SET `information_id`='14', `information_group_id`='1', `information_title`='Términos y condiciones afiliados ', `information_description`='Introduzca aquí los términos y condiciones de afiliados', `information_url`='', `information_target`='_top', `parent_id`='0', `sort_order`='7', `visible`='0', `language_id`='3'  WHERE (`information_id` = 14 AND `language_id` = 3) ;
UPDATE `information` SET `information_id`='1', `information_group_id`='2', `information_title`='TEXT_GREETING_PERSONAL', `information_description`='¡Bienvenido de nuevo <span class="greetUser">%s!</span> ¿Le gustaría ver qué <a href="%s"><u>nuevos productos</u></a> hay disponibles?', `information_url`='', `information_target`='_top', `parent_id`='0', `sort_order`='1', `visible`='1', `language_id`='3'  WHERE (`information_id` = 1 AND `language_id` = 3) ;
UPDATE `information` SET `information_id`='13', `information_group_id`='1', `information_title`='Texto página inicio', `information_description`='<p><font face="arial, helvetica, sans-serif">Para modificar el contenido de esta página, vaya al Panel de administración -> Configuración -> Plantillas -> Páginas de información.</font></p><hr /><p><font face="arial, helvetica, sans-serif">Esto es osCmax v2.5, completo sistema de compras de comercio electrónico.</font></p><p><font face="Arial">El sitio web de soporte es <a href="http://www.oscmax.com/"><font color="#800080">http://www.oscmax.com</font></a>. Hay foros de soporte muy activos, wiki, documentación, descargas y todo lo relacionado con <strong><em>osCmax.</em></strong>.</font></p>', `information_url`='', `information_target`='_top', `parent_id`='0', `sort_order`='1', `visible`='0', `language_id`='3'  WHERE (`information_id` = 13 AND `language_id` = 3) ;
...
UPDATE `information` SET `information_id`='2', `information_group_id`='2', `information_title`='TEXT_GREETING_PERSONAL_RELOGON', `information_description`='<small>Si no es %s, por favor <a href="%s"><u>entre aquí</u></a> e introduzca sus datos.</small>', `information_url`='', `information_target`='_top', `parent_id`='0', `sort_order`='2', `visible`='1', `language_id`='3'  WHERE (`information_id` = 2 AND `language_id` = 3) ;
...
UPDATE `information` SET `information_id`='3', `information_group_id`='2', `information_title`='TEXT_GREETING_GUEST', `information_description`='¡Bienvenido <span class="greetUser">Invitado!</span> ¿Le gustaría <a href="%s"><u>entrar en su cuenta</u></a> o preferiría <a href="%s"><u>crear una cuenta nueva</u></a>?', `information_url`='', `information_target`='_top', `parent_id`='0', `sort_order`='3', `visible`='1', `language_id`='3'  WHERE (`information_id` = 3 AND `language_id` = 3) ;
