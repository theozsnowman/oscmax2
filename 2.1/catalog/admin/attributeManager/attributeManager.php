	...
	?>
			<tr class="option">
				...
				<td align="right">
					...
					<input type="image" title="<?php echo htmlspecialchars(sprintf(AM_AJAX_ADDS_NEW_VALUE_TO_OPTION,$optionInfo['name'])) ?>" border="0" src="attributeManager/images/icon_add_new.png" onclick="return customPrompt('amAddNewOptionValueToProduct','<?php echo addslashes("opti$Id$
<?php
if(false){
?>
...
?>
					<input type="image" border="0" onClick="return customPrompt('amRemoveOptionFromProduct','<?php echo addslashes("opti$Id$

			
					<?php
					if(AM_USE_SORT_ORDER) {
					?>	
					<input type="image" onclick="return amMoveOption('<?php echo 'opti$Id$
					<input type="image" onclick="return amMoveOption('<?php echo 'opti$Id$
					<?php
					}
					?>
...
//-----------------------------
					...
					<input type="image" border="0" onClick="return customPrompt('amEditDownloadForProduct','<?php echo addslashes('opti$Id$
					<input type="image" border="0" onClick="return customPrompt('amDeleteDownloadForProduct','<?php echo addslashes('opti$Id$
							
					<?php
					} else {
					?>
					<input type="image" border="0" onClick="return customPrompt('amAddNewDownloadForProduct','<?php echo addslashes('opti$Id$
<?php					
					}	
...
?>
					<input type="image" border="0" onClick="return customPrompt('amRemoveOptionValueFromProduct','<?php echo addslashes("opti$Id$
					<?php
					if(AM_USE_SORT_ORDER) {
					?>	
						<input type="image" onclick="return amMoveOptionValue('<?php echo 'opti$Id$
						<input type="image" onclick="return amMoveOptionValue('<?php echo 'opti$Id$
					<?php
					}
					?>
...
?>      
			<td align="right">
				...
				<input type="image" border="0" onClick="return customPrompt('amRemoveStockOptionValueFromProduct','<?php echo addslashes("opti$Id$
			</td>
		</tr>
<?php
    }
