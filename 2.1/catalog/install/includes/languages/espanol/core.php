...
define('TEXT_CORRECT_ERROR', '<p class="messageStackAlert">Por favor corrige los errores  mostrados arriba y vuelve a intentar ejecutar el procedimiento de instalación con los cambios aplicados.</p>
');
