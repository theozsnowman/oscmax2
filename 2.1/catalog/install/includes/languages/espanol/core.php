...
define('TEXT_ADMIN_RENAMED_2', '.<br><br>Si quieres leer más información sobre mayores medidas de seguridad puedes echarle un vistazo a la <a href="http://wiki.oscdox.com/setting_up_security" target="_blank">documentación en el Wiki.</a>');
define('TEXT_ADMIN_NOT_RENAMED', '¡No le has cambiado el nombre a la carpeta <b>admin</b>! Te recomendamos encarecidamente que lo hagas para tiendas en producción con el objetivo de aumentar la seguridad.  <br><br>Por favor, lee la <a href="http://wiki.oscdox.com/setting_up_security" target="_blank">documentación en el Wiki para obtener más información sobre cómo tener una adecuada seguridad en tu sitio web.</a>');
