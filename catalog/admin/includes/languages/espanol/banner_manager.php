...
define('TEXT_BANNERS_BANNER_NOTE', '<b>Notas sobre el banner:</b><ul><li>Utiliza imagen o texto HTML para el banner - no ambos.</li><li>El texto HTML tiene prioridad sobre una imagen</li></ul>');
define('TEXT_BANNERS_GROUP_NOTE', '<b>Grupos de banners:</b><ul><li>all - se muestra en el pie de página</li><li>index - se muestra en la página de inicio en el área principal de contenido</li><li>product - se muestra en la  página de product_info</li><li>Se puede cambiar el orden en que se muestran los módulos en el administrador de modulos</li></ul>');
