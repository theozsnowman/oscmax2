...
?>
                <td class="dataTableContent"><?php echo '<span title="' . $rInfo->customers_name . '|' . $rInfo->reviews_text . '">' . tep_image(DIR_WS_ICONS . 'page_white_text.png', ICON_PREVIEW) . '</a>&nbsp;' . tep_get_products_name($reviews['products_id']); ?></span></td>
