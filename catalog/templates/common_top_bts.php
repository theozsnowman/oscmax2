...
*/
?>
<!-- BTSv1.4, current template: <?php echo DIR_WS_TEMPLATES; ?>-->
<?php
...
echo '<br>Remove this menu by setting template switching allowed to false in admin, or by renaming "templates/common_top_bts.php".';
echo '</div>';
}
?>
