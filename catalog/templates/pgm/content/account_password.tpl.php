            ...
            <td><table border="0" width="100%" cellspacing="1" cellpadding="2" class="infoBox">
              <tr class="infoBoxContents">
                <td><table border="0" cellspacing="2" cellpadding="2" width="100%">
                  <tr>
                    <td class="main" width="170"><?php echo ENTRY_PASSWORD_CURRENT; ?></td>
                ...
                <td class="main"><input type="password" id="mypassword" name="password_new" class="inputField" onkeyup="runPassword(this.value, 'mypassword');" /><?php echo '&nbsp;' . (tep_not_null(ENTRY_PASSWORD_TEXT) ? '<span class="inputRequirement">' . ENTRY_PASSWORD_TEXT . '</span>': ''); ?>
