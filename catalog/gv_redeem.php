...
// check for a voucher number in the url
 ...
 $voucher_number=tep_db_prepare_input($HTTP_GET_VARS['gv_no']);
    ...
    $gv_query = tep_db_query("select c.coupon_id, c.coupon_amount from " . TABLE_COUPONS . " c, " . TABLE_COUPON_EMAIL_TRACK . " et where coupon_code = '" . $voucher_number . "' and c.coupon_id = et.coupon_id");
