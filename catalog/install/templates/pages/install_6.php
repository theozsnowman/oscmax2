<?php
/*
$Id: install_6.php 3 2006-05-27 04:59:07Z user $
...
<p><b>osCMax v2.0 Configuration</b></p>
...
<table width="95%" border="0" cellpadding="2" class="formPage">
  ...
  <tr>
    ...
    <td width="70%" class="smallDesc">
      ...
      <div id="dbUser" class="longDescription">The username used to connect to the database server. An example username is 'mysql_10'.<br><br>Note: Create and Drop permissions <b>are not required</b> for the general use of osCMax v2.0.</div>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="70%" class="smallDesc">
      ...
      <div id="dbName" class="longDescription">The database used to hold the data. An example database name is 'osCMax'.</div>
    </td>
  </tr>
  <tr>
