...
define('GOOGLECHECKOUT_STRING_WARN_USING_SANDBOX','GC est configuré pour utiliser SANDBOX. Commande sera traitée mais non inculpés.');
define('GOOGLECHECKOUT_STRING_WARN_NO_MERCHANT_ID_KEY','Id marchands Google Checkout ou Key n\'a pas été mis en place');
define('GOOGLECHECKOUT_STRING_WARN_VIRTUAL','Certains produits de télécharger dans votre panier ne sont pas actuellement disponibles via Google Checkout.');
...
define('GOOGLECHECKOUT_STRING_WARN_MULTIPLE_SHIP_TAX','Il existe de multiples options de livraison sélectionné et ils utilisent différentes tables d\'impôt expédition ou certains tableaux n\'avez pas la taxe d\'utilisation');
define('GOOGLECHECKOUT_STRING_WARN_MIX_VERSIONS','La version du module installé dans l\'interface d\'administration est %s et celui de l\'emballage est %s, supprimer / réinstaller le module');
