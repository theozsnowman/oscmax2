...
define('MAILCHIMP_EXISTING_USER_UNSUBSCRIBED', 'Vous n\'êtes pas abonnés à notre bulletin d\'information');
...
define('IMAGE_BUTTON_UNSUBSCRIBE', 'Se désabonner');
...
define('ENTRY_COMPANY_TAX_ID', 'Num&eacute;ro intracommunataire IBLC:');
...
define('WARNING_INSTALL_DIRECTORY_EXISTS', 'Attention, le r&eacute;pertoire d\'installation existe &agrave; :' . dirname($HTTP_SERVER_VARS['SCRIPT_FILENAME']) . '/install. Il est vinement conseillé de supprimer ce r&eacute;pertoire pour des raisons de s&eacute;curit&eacute;.');
...
define('QUANTITY_BLOCKS_NOTICE', '%s ne peuvent être command&eacute;s par multiple de %d. Le contenu de votre panier d\'achat a été ajusté en conséquence.');
// EOF: QPBPP for SPPC

// BOF: Customer Comments contrib
define('SUCCESS_ORDER_UPDATED', 'Succès: Votre commande a &eacute;t&eacute; correctement mis &agrave; jour.');
...
// Recent History
define('TEXT_LAST_VISITED_PRODUCTS', 'Vos articles visualisés');
...
define('TEXT_QUESTION_TYPE', 'Tapez%20votre%20question%20ci-dessous:');
define('TEXT_QUESTION_PRICE_ENQUIRY', 'Demande%20de%20prix');
define('TEXT_QUESTION_PRODUCT_NAME', 'Nom%20du%20produit:');

define('DOWNLOADS_CONTROLLER_ON_HOLD_MSG', 'NOTE: Les téléchargements ne sont pas disponibles tant que le paiement n\'a pas été confirmé.');
