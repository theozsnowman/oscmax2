...
define('WARNING_INSTALL_DIRECTORY_EXISTS', 'Attention, le r&eacute;pertoire d\'installation existe &agrave; :' . dirname($_SERVER['SCRIPT_FILENAME']) . '/install. Il est vinement conseill&eacute; de supprimer ce r&eacute;pertoire pour des raisons de s&eacute;curit&eacute;.');
define('WARNING_CONFIG_FILE_WRITEABLE', 'Attention: Il est possible d\'&eacute;crire sur le fichier de configuration: ' . dirname($_SERVER['SCRIPT_FILENAME']) . '/includes/configure.php. Ceci est un risque potentiel - merci de mettre les bonnes permissions sur ce fichier.');
