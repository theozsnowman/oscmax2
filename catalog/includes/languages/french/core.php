...
define('HEADER_TITLE_BASKET_CONTENTS', 'Voir mon panier');
define('HEADER_TITLE_CHECKOUT', 'Commander');
define('HEADER_TITLE_WISHLIST', 'Liste des souhaits');
...
define('MAILCHIMP_INTRO_TEXT_SUBSCRIBED', 'Vous êtes actuellement abonné à notre bulletin d\'information');
...
define('MAILCHIMP_EXISTING_USER_UNSUBSCRIBED', 'Vous <strong>n\'êtes pas</strong> abonnés à notre bulletin d\'information');
define('MAILCHIMP_HTML', 'HTML');
define('MAILCHIMP_TEXT', 'Text');
define('MAILCHIMP_MISSING_INTRO', 'Malheureusement, vous n\'avez pas saisi toutes les informations nécessaires à votre configuration MailChimp. <br><br><b>Missing Settings:</b>');
...
define('IMAGE_BUTTON_UNSUBSCRIBE', 'Désabonner');
...
define('JS_ERROR_SUBMITTED', 'Ce formulaire a été déj&agrave; soumis. Veuillez appuyer sur Ok et attendez jusqu\'&agrave; ce que le traitement soit fini.');

define('ERROR_NO_PAYMENT_MODULE_SELECTED', 'Veuillez choisir une mode de paiement pour votre commande.');

define('CATEGORY_COMPANY', 'Infos de la sociét&eacute');
...
define('ENTRY_COMPANY_ERROR', 'S\'il vous plaît entrer votre nom de la sociét&eacute');
define('ENTRY_COMPANY_TEXT', '*');
define('ENTRY_COMPANY_TAX_ID', 'Numéro intracommunataire IBLC:');
define('ENTRY_COMPANY_TAX_ID_ERROR', 'S\'il vous plaît entrer votre Numéro intracommunataire IBLC');
define('ENTRY_COMPANY_TAX_ID_TEXT', '*');
define('ENTRY_GENDER', 'Sexe;:');
define('ENTRY_GENDER_ERROR', 'Sélectionner votre sexe.');
...
define('ENTRY_EMAIL_ADDRESS_CHECK_ERROR', 'Votre courriel ne semble pas &ecirc;tre valide - veuillez effectuer toutes les corrections nécessaires.');
define('ENTRY_EMAIL_ADDRESS_ERROR_EXISTS', 'Votre courriel est déj&agrave; enregistrée sur notre site - Veuillez ouvrir une session avec cette adresse courriel ou créez un compte avec une adresse différente.');
...
define('ENTRY_CITY_ERROR', 'Votre nom de ville doit contenir un minimum de ' . ENTRY_CITY_MIN_LENGTH . ' caractères.');
define('ENTRY_CITY_TEXT', '*');
define('ENTRY_STATE_TEXT', '* (Sélectionez dabord un pays)');
define('ENTRY_COUNTRY', 'Pays:');
define('ENTRY_COUNTRY_ERROR', 'Veuillez choisir un pays &agrave; partir de la liste déroulante.');
define('ENTRY_COUNTRY_TEXT', '* (Page sera actualisée lors d\'un changement)');
define('ENTRY_TELEPHONE_NUMBER', 'Numéro de téléphone:');
define('ENTRY_TELEPHONE_NUMBER_ERROR', 'Votre numéro de téléphone doit contenir un minimum de ' . ENTRY_TELEPHONE_MIN_LENGTH . ' chiffre.');
define('ENTRY_TELEPHONE_NUMBER_TEXT', '*');
define('ENTRY_FAX_NUMBER', 'Numéro de fax:');
define('ENTRY_FAX_NUMBER_ERROR', 'S\'il vous plaît entrer votre numéro de fax');
...
define('IMAGE_BUTTON_EDIT_ACCOUNT', 'éditer votre Compte');
...
define('IMAGE_BUTTON_DOWNSORT', 'Ordre décroissant');
// EOF: MOD - CATALOG_PRODUCTS_WITH_IMAGES_mod

//2 LINES ADDED: MOD - Down For Maintenance
define('TEXT_BEFORE_DOWN_FOR_MAINTENANCE', 'NOTIFICATION: Ce site sera fermé pour maintenance le: ');
define('TEXT_ADMIN_DOWN_FOR_MAINTENANCE', 'NOTIFICATION: Ce site web est actuellement en maintenance et fermé au public');
...
define('WARNING_INSTALL_DIRECTORY_EXISTS', 'Attention, le répertoire d\'installation existe &agrave; :' . dirname($HTTP_SERVER_VARS['SCRIPT_FILENAME']) . '/install. Il est vinement conseillé de supprimer ce répertoire pour des raisons de sécurité.');
define('WARNING_CONFIG_FILE_WRITEABLE', 'Attention: Il est possible d\'écrire sur le fichier de configuration: ' . dirname($HTTP_SERVER_VARS['SCRIPT_FILENAME']) . '/includes/configure.php. Ceci est un risque potentiel - merci de mettre les bonnes permissions sur ce fichier.');
...
define('WARNING_SEO_PHP_VERSION_LOW', 'Attention: Votre serveur web est en cours d\'exécution ' . PHP_VERSION . ' qui n\'est pas suffisante pour pouvoir utiliser les SEO URLs. S\'il vous pla&icirc;t désactiver ce module jusqu\'&agrave; ce que vous avez mis &agrave; niveau votre version de PHP.');
define('WARNING_SESSION_AUTO_START', 'Attention: session.auto_start est actif - désactiver cette fonctionnalité dans php.ini et redémarrer le serveur.');
...
define('TEXT_CCVAL_ERROR_INVALID_DATE', 'La date d\'expiration entrée pour cette carte de crédit n\'est pas valide.<br>Veuillez vérifier la date et réessayez.');
define('TEXT_CCVAL_ERROR_INVALID_NUMBER', 'Le numé entrée pour cette carte de crédit n\'est pas valide.<br>Veuillez vérifier le numéro et réessayez.');
define('TEXT_CCVAL_ERROR_UNKNOWN_CARD', 'Le code &agrave; 4 chiffres que vous avez entré est: %s<br>Si ce code est correcte, nous n\'acceptons pas ce type de carte crédit.<br>S\'il est erroné, veuillez réessayer.');
define('WARNING_JAVASCRIPT_DISABLED', 'Attention: Nous avons détecté que vous avez désactivé Javascript. Pour une bonne utuilisation de ce site, vous devez l\'aciver. Si vous avez besoin d\'aide, <b>cliquez ici.</b>');
define('WARNING_IE6_DETECTED', 'Attention: Nous avons détecté que vous utilisez Internet Explorer 6 qui est instable. Nous vous recommandons vivement de <b>mettre à jour votre navigateur</b>. Pourquoi ne pas essayer <a href="http://www.microsoft.com/windows/internet-explorer/default.aspx"><b>IE</b></a>, <a href="http://www.mozilla.com/"><b>Firefox</b></a> ou <a href="http://www.google.co.uk/chrome/"><b>Chrome</b></a>');

define('FOOTER_TEXT_BODY', 'Tous droits réservés &copy; ' . date('Y') . ' <a href="' . tep_href_link(FILENAME_DEFAULT) . '">' . STORE_NAME . '</a><br>Powered by <a href="http://www.oscmax.com" target="_blank">' . PROJECT_VERSION . '</a>');
...
define('BOX_LOGINBOX_TEXT_NEW', 'Créer un compte');
define('BOX_LOGINBOX_NEW', 'créer un compte');
define('BOX_LOGINBOX_FORGOT_PASSWORD', 'Mot de passe');
define('BOX_HEADING_LOGIN_BOX_MY_ACCOUNT', 'Information de mon compte');
define('LOGIN_BOX_ACCOUNT_EDIT', 'Ã‰diter information compte.');
...
define('LOGIN_BOX_MY_ACCOUNT', 'Information générale');
...
// BOF: QPBPP for SPPC
define('MINIMUM_ORDER_NOTICE', 'Montant minimum de commande pour %s is %d. Le contenu de votre panier d\'achat a été ajusté en conséquence.');
define('QUANTITY_BLOCKS_NOTICE', '%s ne peuvent être commandés par multiple de %d. Le contenu de votre panier d\'achat a été ajusté en conséquence.');
// EOF: QPBPP for SPPC

// BOF: Customer Comments contrib
define('SUCCESS_ORDER_UPDATED', 'Succès: Votre commande a été correctement mis &agrave; jour.');
define('WARNING_ORDER_NOT_UPDATED', 'Attention: Rien &agrave; changer. La commande n\'a pas été mis &agrave; jour.');
// EOF: Customer Comments contrib

// BOF: Open Featured Sets
define('OPEN_FEATURED_BOX_HEADING', 'Produits recommandés');
define('OPEN_FEATURED_BOX_CATEGORY_HEADING', 'Categories recommandées');
...
define('TEXT_PRODUCTS_SAVINGS', '&nbsp;Vous&nbsp;économisez:&nbsp;');
define('TEXT_PRODUCTS_PRICENOW', '&nbsp;MAINTENANT:&nbsp;');
define('TEXT_PRODUCTS_USUALPRICE', '&nbsp;Prix&nbsp;conseillé:&nbsp;');
// EOF: MSRP
...
// Product listing
define('TEXT_PRODUCT_NAME_AZ', 'Nom de produit de A à Z');
define('TEXT_PRODUCT_NAME_ZA', 'Non de produits de Z à A');
define('TEXT_PRICE_LOW_HIGH', 'Prix (Bas - Elevé)');
define('TEXT_PRICE_HIGH_LOW', 'Prix (Elevé - Bas)');
define('TEXT_SHOW_ALL', 'Afficher tout');
define('TEXT_VIEW_AS_LIST', 'Afficher comme une List');
define('TEXT_VIEW_AS_GRID', 'Affficher comme grille');
define('TEXT_RESULTS_PAGE', 'Résultats/Page: ');
define('TEXT_SORT_ORDER', 'Ordre de tri: ');
define('TEXT_PRICE_BESTSELLER', 'Meilleures ventes');

// Recent History
define('TEXT_LAST_VISITED_PRODUCTS', 'Vos produits consultés');
...
define('TEXT_SHIPPING_NEAR_PRICE', 'Expédition');
// EOF Show tax and Shipping near price

// text for last update
define('TEXT_LAST_UPDATE', 'Dernière mise &agrave; jour:');
?>