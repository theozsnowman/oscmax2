<?php
/*
$Id: affiliate_banners_build.php 982 2011-01-06 02:53:12Z michael.oscmax@gmail.com $
...
define('TEXT_INFORMATION','Entrez le num&eacute;ro d\'identification du produit que vous souhaitez cr&eacute;er un lien pour:');
...
define('TEXT_AFFILIATE_INDIVIDUAL_BANNER_INFO','Entrez le num&eacute;ro de produit que vous souhaitez faire un lien vers et appuyez sur Entr&eacute;e');
...
define('TEXT_AFFILIATE_INDIVIDUAL_BANNER_HELP','S&eacute;lectionnez le num&eacute;ro de produit de la fenêtre popup et entrez le num&eacute;ro dans le champ Build A Link.');

define('TEXT_VALID_PRODUCTS_LIST','Disponible Liste des Produits');
