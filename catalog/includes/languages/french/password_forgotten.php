...
define('EMAIL_PASSWORD_REMINDER_SUBJECT', ' - Nouveau mot de passe');
define('EMAIL_PASSWORD_REMINDER_BODY', 'Un nouveau mot de passe a &eacute;t&eacute; demand&eacute; de %s.' . "\n\n" . 'Votre nouveau mot de passe sur %s est:' . "\n\n" . '   %s' . "\n\n");
