...
define('HEADING_TITLE', 'Werbepartner: Klicks');
...
define('HEADING_CLICKTHROUGH_HELP', 'Werbepartner Hilfe');
...
define('TEXT_REFFERED_HELP', '<i>Referrer</i> zeigt die URL an, woher ein Besucher dieses Shops gekommen ist.');
?>