...
define('MODULE_SHIPPING_RMSPECIAL_TEXT_WAY', 'Peso de la entrega');
define('MODULE_SHIPPING_RMSPECIAL_TEXT_ITEM', 'paquete de');
define('MODULE_SHIPPING_RMSPECIAL_TEXT_ITEMS', 'paquetes de');
