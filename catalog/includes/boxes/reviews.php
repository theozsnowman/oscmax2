...
<?php
  ...
  $boxLink = '<a href="' . tep_href_link(FILENAME_REVIEWS) . '"><img src="' . DIR_WS_TEMPLATES . 'images/infobox/arrow_right.png" border="0" alt="' . ICON_ARROW_RIGHT . '" title="' . ICON_ARROW_RIGHT . '"></a>';
