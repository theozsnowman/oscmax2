...
<?php
  ...
  $boxLink = '<a href="' . tep_href_link(FILENAME_DEFAULT, "show_specials=1") . '"><img src="' . DIR_WS_TEMPLATES . 'images/infobox/arrow_right.png" border="0" alt="' . ICON_ARROW_RIGHT . '" title="' . ICON_ARROW_RIGHT . '"></a>';
