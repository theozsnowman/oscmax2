...
class parcelforce48 {
	...
	function parcelforce48() {
		...
		$this->version = ((defined('MODULE_SHIPPING_PARCELFORCE48_VERSION')) ? MODULE_SHIPPING_PARCELFORCE48_VERSION : '?.?');
	...
	function install() {
		...
		tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Maximum value to ship', 'MODULE_SHIPPING_PARCELFORCE48_MAX_VALUE', '2500', 'Enter the maximum value to ship', '6', '0', now())");
		...
		for ($i = 1; $i <= $this->num_zones; $i++) {
			...
			if ($i == 1) {
				...
				$shipping_table = '10:15.99,12:19.99,14:20.99,16:21.99,18:21.99,20:21.99,22:26.99,24:30.99,26:34.99,28:38.99,30:42.99,35:52.99,40:62.99,45:72.99,50:82.99,55:92.99,60:102.99,65:112.99,70:122.99,75:132.99,80:142.99,85:152.99,90:162.99,95:172.99,100:182.99';
				$shipping_compensation = '150:0,500:12,1000:24,1500:36,2000:48,2500:60';
				$shipping_handling = 0;
			}
