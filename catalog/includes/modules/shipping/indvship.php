...
$products = $cart->get_products();
 ...
 if (tep_not_null($shiptotal) || tep_not_null($indvcount) || $shiptotal == '0'){
	...
	function install() {
		tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('CT_MODULE_SHIPPING_INDVSHIP_STATUS', 'MODULE_SHIPPING_INDVSHIP_STATUS', 'True', 'CD_MODULE_SHIPPING_INDVSHIP_STATUS', '6', '0', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now())");
		tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) values ('CT_MODULE_SHIPPING_INDVSHIP_TAX_CLASS', 'MODULE_SHIPPING_INDVSHIP_TAX_CLASS', '0', 'CD_MODULE_SHIPPING_INDVSHIP_TAX_CLASS', '6', '0', 'tep_get_tax_class_title', 'tep_cfg_pull_down_tax_classes(', now())");
		tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, use_function, set_function, date_added) values ('CT_MODULE_SHIPPING_INDVSHIP_ZONE', 'MODULE_SHIPPING_INDVSHIP_ZONE', '0', 'CD_MODULE_SHIPPING_INDVSHIP_ZONE', '6', '0', 'tep_get_zone_class_title', 'tep_cfg_pull_down_zone_classes(', now())");
		tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('CT_MODULE_SHIPPING_INDVSHIP_SORT_ORDER', 'MODULE_SHIPPING_INDVSHIP_SORT_ORDER', '0', 'CD_MODULE_SHIPPING_INDVSHIP_SORT_ORDER', '6', '0', now())");
